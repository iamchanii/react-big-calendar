...
function TimeGridEvent(props) {
  ...
  var style = props.style,
      ...
      EventInnerWrapper = _props$components$eve === void 0 ? _NoopWrapper.default : _props$components$eve;
  ...
  return _react.default.createElement(EventWrapper, (0, _extends3.default)({
    type: "time"
  }, props), _react.default.createElement(EventInnerWrapper, {
    onClick: onClick,
    onDoubleClick: onDoubleClick,
    style: (0, _extends3.default)({}, userProps.style, (_extends2 = {
      top: top + "%",
      height: "calc(" + height + "% - 2px)"
    }, _extends2[rtl ? 'right' : 'left'] = Math.max(0, xOffset) + "%", _extends2.width = "" + width, _extends2.marginLeft = marginLeft + "px", _extends2.left = left + "%", _extends2)),
